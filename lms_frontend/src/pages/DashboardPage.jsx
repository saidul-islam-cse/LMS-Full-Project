...
import AddCourse from "./AddCourese";
...
function DashboardPage() {
      ...
      icon: (
        ...
        >
          ...
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
            d="M12 6v12m0 0l-8-4.5M12 18l8-4.5M4 6l8 4.5 8-4.5"
          />
        </svg>
      ),
      onClick: () => {
        setCurrentPage("courses"); // Course page navigate
        setShowProfile(false);
      },
      active: currentPage === "courses" && !showProfile,
    },
  ...
  const renderContent = () => {
    switch (currentPage) {
      ...
      case "courseDetail":
        return <CourseDetailPage courseId={selectedCourseId}  />;
      case "addCourse":
        return <AddCourse />;
      case "register":
        return <RegisterPage />;
